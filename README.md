...
|--------------|-----------------|------------|------------------|
| Электроника  | Компьютеры      | Ноутбуки   | Ноутбук Dell     |
| Материалы    | Крепеж          | Метизы     | Болт М6          |
| Инструменты  | Измерительные   | Приборы    | Мультиметр Fluke |
...
- [x] **Поиск по каталогу:** иерархические категории + boost + фильтрация
