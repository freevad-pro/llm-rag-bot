...
| D | category | String | ✅ | Категория |
| E | article | String | ✅ | Артикул |
| F | photo_url | String | ❌ | URL фотографии |
| G | specifications | JSON | ❌ | Технические характеристики |
| H | keywords | String | ❌ | Ключевые слова через запятую |
```
